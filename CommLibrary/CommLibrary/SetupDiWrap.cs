 ...
 *文件名：  Class1
 *版本号：  V1.0.0.0
 *唯一标识：b0c8169f-8a9f-4aa7-a65f-020e51cd5ad1
 *当前的用户域：SEIKAKU
 *创建人：  williamxia
 *电子邮箱：XXXX@sina.cn
 *创建时间：12/27/2016 11:34:59 AM
 *描述：
 *
 *=====================================================================
 *修改标记
 *修改时间：12/27/2016 11:34:59 AM
 *修改人： williamxia
 *版本号： V1.0.0.0
 *描述：
 *
...
namespace CommLibrary
{
    public class SetupDiWrap
    {
        ...
        private static Guid[] GetClassGUIDs(string className)
        {
            ...
            SetupDiClassGuidsFromName(className, ref guidArray[0], 1, out requiredSize);
